...
- build docker image
  ...
  ```ps1
    docker build -f ./Crawer_104/Dockerfile -t arisuokay/job-seeker-crawer-104:v2.9 -t arisuokay/job-seeker-crawer-104:latest .
    docker push arisuokay/job-seeker-crawer-104:v2.9
    docker push arisuokay/job-seeker-crawer-104:latest

    docker build -f ./Crawer_CakeResume/Dockerfile -t arisuokay/job-seeker-crawer-cakeresume:v2.8 -t arisuokay/job-seeker-crawer-cakeresume:latest .
    docker push arisuokay/job-seeker-crawer-cakeresume:v2.8
