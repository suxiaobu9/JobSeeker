...
- build docker image
  ...
  ```ps1
    ...
    docker build -f ./Crawer_1111/Dockerfile -t arisuokay/job-seeker-crawer-1111:v2.8 -t arisuokay/job-seeker-crawer-1111:latest .
    docker push arisuokay/job-seeker-crawer-1111:v2.8
