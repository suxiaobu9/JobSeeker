...
- build docker image
  ...
  ```ps1
    docker build -f ./Crawer_104/Dockerfile -t arisuokay/job-seeker-crawer-104:v2.11 -t arisuokay/job-seeker-crawer-104:latest .
    docker push arisuokay/job-seeker-crawer-104:v2.11
    docker push arisuokay/job-seeker-crawer-104:latest

    docker build -f ./Crawer_CakeResume/Dockerfile -t arisuokay/job-seeker-crawer-cakeresume:v2.10 -t arisuokay/job-seeker-crawer-cakeresume:latest .
    docker push arisuokay/job-seeker-crawer-cakeresume:v2.10
    docker push arisuokay/job-seeker-crawer-cakeresume:latest

    docker build -f ./Web/Dockerfile -t arisuokay/job-seeker-web:v1.10 -t arisuokay/job-seeker-web:latest .
    docker push arisuokay/job-seeker-web:v1.10
