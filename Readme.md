...
- build docker image
  ...
  ```ps1
    docker build -f ./Crawer_104/Dockerfile -t arisuokay/job-seeker-crawer-104:v2.28 -t arisuokay/job-seeker-crawer-104:latest .
    docker push arisuokay/job-seeker-crawer-104:v2.28
    ...
    docker build -f ./Crawer_1111/Dockerfile -t arisuokay/job-seeker-crawer-1111:v2.4 -t arisuokay/job-seeker-crawer-1111:latest .
    docker push arisuokay/job-seeker-crawer-1111:v2.4
